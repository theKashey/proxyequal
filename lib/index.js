...
var ProxyPolyfill = require('proxy-polyfill/src/proxy');
//const ProxyConstructor = typeof Proxy !== 'undefined' ? Proxy : ProxyPolyfill();
var ProxyConstructor = ProxyPolyfill();
...
function proxyfy(state, report) {
  ...
  var proxy = new ProxyConstructor(Array.isArray(state) || isProxyfied(state) ? state : Object.assign({}, state), {
