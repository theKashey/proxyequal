...
var deepDeproxySymbol = typeof Symbol !== 'undefined' ? Symbol('deepDeproxy') : '__magic__deepDeproxySymbol';
...
function proxyfy(state, report) {
  ...
  var proxy = new Proxy(Array.isArray(state) || state[deproxySymbol] ? state : Object.assign({}, state), {
